...
static const _InferenceResult_type_support_symbol_names_t _InferenceResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolov8_obb_msgs, msg, InferenceResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolov8_obb_msgs, msg, InferenceResult)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yolov8_obb_msgs, msg, InferenceResult)() {
  return &::yolov8_obb_msgs::msg::rosidl_typesupport_c::InferenceResult_message_type_support_handle;
}
