...
static const _Yolov8Inference_type_support_symbol_names_t _Yolov8Inference_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolov8_obb_msgs, msg, Yolov8Inference)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolov8_obb_msgs, msg, Yolov8Inference)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yolov8_obb_msgs, msg, Yolov8Inference)() {
  return &::yolov8_obb_msgs::msg::rosidl_typesupport_c::Yolov8Inference_message_type_support_handle;
}
