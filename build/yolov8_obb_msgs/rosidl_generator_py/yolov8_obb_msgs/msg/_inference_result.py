...
class Metaclass_InferenceResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('yolov8_obb_msgs')
        except ImportError:
            import logging
            import traceback
    ...
    def coordinates(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'coordinates' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
