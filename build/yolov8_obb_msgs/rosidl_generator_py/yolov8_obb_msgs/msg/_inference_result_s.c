...
bool yolov8_obb_msgs__msg__inference_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_obb_msgs.msg._inference_result.InferenceResult", full_classname_dest, 53) == 0);
  }
  yolov8_obb_msgs__msg__InferenceResult * ros_message = _ros_message;
  {  // class_name
  ...
  {  // coordinates
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->coordinates.data;
...
PyObject * yolov8_obb_msgs__msg__inference_result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_obb_msgs.msg._inference_result");
  ...
  {  // coordinates
    ...
    if (ros_message->coordinates.size > 0) {
      ...
      double * src = &(ros_message->coordinates.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->coordinates.size * sizeof(double));
      assert(data != NULL);
