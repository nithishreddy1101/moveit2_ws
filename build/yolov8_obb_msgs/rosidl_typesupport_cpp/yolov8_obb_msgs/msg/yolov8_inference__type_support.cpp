...
static const _Yolov8Inference_type_support_symbol_names_t _Yolov8Inference_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_obb_msgs, msg, Yolov8Inference)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov8_obb_msgs, msg, Yolov8Inference)),
  }
};
...
{
  return &::yolov8_obb_msgs::msg::rosidl_typesupport_cpp::Yolov8Inference_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yolov8_obb_msgs, msg, Yolov8Inference)() {
  return get_message_type_support_handle<yolov8_obb_msgs::msg::Yolov8Inference>();
}
