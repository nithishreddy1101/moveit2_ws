...
#include "yolov8_obb_msgs/msg/detail/inference_result__rosidl_typesupport_fastrtps_c.h"
...
using _InferenceResult__ros_msg_type = yolov8_obb_msgs__msg__InferenceResult;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_obb_msgs__msg__InferenceResult;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yolov8_obb_msgs__msg__InferenceResult * ros_message = static_cast<const yolov8_obb_msgs__msg__InferenceResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yolov8_obb_msgs__msg__InferenceResult(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yolov8_obb_msgs__msg__InferenceResult * ros_message = static_cast<yolov8_obb_msgs__msg__InferenceResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yolov8_obb_msgs__msg__InferenceResult(cdr, ros_message);
}

static uint32_t _InferenceResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolov8_obb_msgs__msg__InferenceResult(
...
static size_t _InferenceResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yolov8_obb_msgs__msg__InferenceResult(
