...
#include "yolov8_obb_msgs/msg/detail/inference_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolov8_obb_msgs::msg::InferenceResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolov8_obb_msgs::msg::InferenceResult & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_obb_msgs::msg::InferenceResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolov8_obb_msgs::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov8_obb_msgs::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  return &yolov8_obb_msgs::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_obb_msgs, msg, InferenceResult)() {
  return &yolov8_obb_msgs::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
