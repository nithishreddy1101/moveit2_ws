...
#include "yolov8_obb_msgs/msg/detail/yolov8_inference__struct.hpp"
...
{
  new (message_memory) yolov8_obb_msgs::msg::Yolov8Inference(_init);
}

void Yolov8Inference_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolov8_obb_msgs::msg::Yolov8Inference *>(message_memory);
  typed_message->~Yolov8Inference();
}

size_t size_function__Yolov8Inference__yolov8_inference(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<yolov8_obb_msgs::msg::InferenceResult> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<yolov8_obb_msgs::msg::InferenceResult> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<yolov8_obb_msgs::msg::InferenceResult> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const yolov8_obb_msgs::msg::InferenceResult *>(
    get_const_function__Yolov8Inference__yolov8_inference(untyped_member, index));
  auto & value = *reinterpret_cast<yolov8_obb_msgs::msg::InferenceResult *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<yolov8_obb_msgs::msg::InferenceResult *>(
    get_function__Yolov8Inference__yolov8_inference(untyped_member, index));
  const auto & value = *reinterpret_cast<const yolov8_obb_msgs::msg::InferenceResult *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Yolov8Inference_message_member_array[2] = {
  {
    ...
    offsetof(yolov8_obb_msgs::msg::Yolov8Inference, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<yolov8_obb_msgs::msg::InferenceResult>(),  // members of sub message
    false,  // is key
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(yolov8_obb_msgs::msg::Yolov8Inference, yolov8_inference),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Yolov8Inference_message_members = {
  ...
  2,  // number of fields
  sizeof(yolov8_obb_msgs::msg::Yolov8Inference),
...
get_message_type_support_handle<yolov8_obb_msgs::msg::Yolov8Inference>()
{
  return &::yolov8_obb_msgs::msg::rosidl_typesupport_introspection_cpp::Yolov8Inference_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov8_obb_msgs, msg, Yolov8Inference)() {
  return &::yolov8_obb_msgs::msg::rosidl_typesupport_introspection_cpp::Yolov8Inference_message_type_support_handle;
}
